...
(user_id,parking_date,booking_time,start_time,end_time,slot_id,parking_cost,payment_mode,ticket_id,qr_image)
values
('$user_id','$parking_date',NOW(),'$start_time','$end_time','$slot_id','$parking_cost','$payment_mode','$ticket_id','$file')";
